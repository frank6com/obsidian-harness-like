...
const dict: Record<string, string> = {
  ...
  'pm.cap.block': 'Blocks',
  'blocks.conflict': 'Block language {lang} is already owned by plugin {owner}. Rename it in the plugin details.',
  'blocks.invalid': 'Invalid block language: {lang} (must start with hl:, no whitespace)',
  'blocks.placeholderNotRunning': '⏸ Plugin for block {lang} is not running',
  'blocks.placeholderRenamed': '↷ Block renamed to {lang}; this entry is kept as a hint only',
  ...
  'pm.detail.blocksTitle': 'Block languages',
  'pm.detail.blockHint': 'Languages must start with hl:, contain no whitespace and be globally unique. Changes apply immediately; old spellings show a rename hint in notes.',
  'pm.detail.blockRename': 'Save',
  'pm.detail.blockSaved': 'Block {type} language changed to {lang}',
  'pm.detail.blockConflict': 'conflict',

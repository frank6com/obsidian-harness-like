...
const dict: Record<string, string> = {
  ...
  'files.downloading': '⏳ Stylesheet missing — auto-downloading…',
  'files.restored': '✅ Stylesheet auto-restored. Reload the plugin to apply.',
  'files.failed': '⚠ Stylesheet download failed (network restricted). Try uninstalling and reinstalling from the community store, or restore manually below.',

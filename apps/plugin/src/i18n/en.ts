...
const dict: Record<string, string> = {
  ...
  'files.title': 'Plugin files incomplete (styles.css missing)',
  ...
  'files.failed': 'Auto-download failed (network restricted). Try uninstalling and reinstalling this plugin from the community store, or install manually with the buttons below.',
  'files.reload': 'Reload now',
  'files.retry': 'Retry',
  'files.dir': 'Plugin folder: ',
  'files.openRelease': 'Download styles.css (GitHub release)',

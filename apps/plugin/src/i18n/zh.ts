...
const dict: Record<string, string> = {
  ...
  'pm.cap.protocol': '深链',
  'pm.cap.block': '块',
  'blocks.conflict': '块语言串 {lang} 已被插件 {owner} 占用，请在插件详情中改名',
  'blocks.invalid': '非法块语言串：{lang}（需以 hl: 开头、无空白）',
  'blocks.placeholderNotRunning': '⏸ 块 {lang} 所属插件未运行',
  'blocks.placeholderRenamed': '↷ 块已改名为 {lang}，此入口仅作提示',
  ...
  'pm.detail.blocksTitle': '块语言名',
  'pm.detail.blockHint': '语言串需以 hl: 开头、无空白且全局唯一；修改后立即生效，旧写法在笔记中显示改名提示。',
  'pm.detail.blockRename': '保存',
  'pm.detail.blockSaved': '块 {type} 语言已改为 {lang}',
  'pm.detail.blockConflict': '冲突',

...
const dict: Record<string, string> = {
  ...
  'pm.cap.protocol': '深链',
  'pm.cap.block': '块',
  'blocks.registerFailed': '块处理器注册失败：hl 命名空间可能被其它插件占用',
  'blocks.placeholderNotRunning': '⏸ 插件 {pluginId} 未运行或未注册该块',
  'blocks.placeholderNeedType': '⚠ 插件 {pluginId} 有多个块类型，请指定其中一个：{types}',
  'blocks.placeholderLegacy': '↷ 旧写法已不支持，请改为：{sample}',
  'blocks.placeholderBadInfo': '⚠ 该块无法渲染：缺少插件 id，应为 ```hl <插件id>[:<类型>] [参数...]',
  'blocks.placeholderNolocate': '⚠ 未能定位该块的参数（可能与相邻的空内容块有关），以下为原始内容',
  'blocks.placeholderEmpty': '⏹ 此块内容为空——请在 ``` 与 ``` 之间填写内容后渲染',
  ...
  'pm.detail.blocksTitle': '块渲染',
  'pm.detail.blockHint':
    '在笔记中写 ```hl <插件id>[:<类型>] [参数...] 即可由本插件渲染；参数支持 k:v、k=v、k:"含空格的值"、--开关。',
  'pm.detail.blockInsert': '插入',
  'pm.detail.blockCopy': '复制',
  'pm.detail.blockInserted': '已插入块模板到当前笔记',
  'pm.detail.blockCopied': '已复制块模板',
  'pm.detail.blockCopyFailed': '复制失败，请手动选中语法后复制',
  'pm.detail.blockNoEditor': '当前没有打开的笔记，无法插入',
  'pm.detail.aliasTitle': '插件别名',
  'pm.detail.aliasHint': '留空清除；设置后可在笔记中写 ```hl <别名>[:<类型>] 缩短输入',
  'pm.detail.aliasSaved': '别名已设为 {alias}',
  'pm.detail.aliasCleared': '别名已清除',
  'pm.detail.aliasInvalid': '别名非法：需以小写字母或数字开头，仅含 - _ ，且不超过 32 字符',
  'pm.detail.aliasReserved': '别名不能是保留字 hl',
  'pm.detail.aliasTakenById': '别名不能与插件 id {alias} 相同',
  'pm.detail.aliasTakenByAlias': '别名 {alias} 已被其它插件占用',
  ...
  'pm.deleted.hint': '以下插件目录已删除，备份仍保留，可恢复或永久删除：',
  'pm.deleted.clearAll': '清空全部',
  'pm.deleted.clearConfirm': '将永久删除 {count} 个已删除插件的全部备份，之后无法再恢复这些插件。确定继续？',
  'pm.deleted.cleared': '已清空 {count} 个插件的备份',
  'pm.deleted.purge': '永久删除',
  'pm.deleted.purgeConfirm': '将永久删除 {id} 的全部 {count} 份备份，之后无法再恢复该插件。确定继续？',
  'pm.deleted.purged': '已永久删除: {id}',

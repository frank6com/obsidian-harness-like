...
This section is for **developers/contributors of the Harness Like plugin itself** — not to be confused with [Plugin Development](/dev/hello-world), which teaches Obsidian users how to write their own user plugins.
...
See [Workflow](/development/workflow), [Versioning](/development/versioning), [Release](/development/release) and [Conventions](/development/conventions).

...
- **Create plugins in conversation**: panels, commands, tools, icons, translations, obsidian:// deep links — no coding; the AI verifies generated code (syntax & forbidden APIs) before loading;
...
- **对话内创建子插件**：面板、命令、工具、图标、翻译、obsidian:// 深链——零代码；AI 加载前自动校验生成代码（语法与禁用 API）；
